            ...
            <div className="py-2 mx-auto md:px-10 w-full max-w-7xl">
                ...
                <div>
                    <div className='flex flex-col items-center gap-10 -mt-[80px] '>
                        ...
                        <Button className='bg-primary border-none text-base rounded-xl leading-120 font-poppins  py-3 px-7 hover:bg-transparent hover:border-dark-1 hover:border-2 hover:border-solid ' >
                            Start for free
                        </Button>
                    </div>
                </div>
                <div className="flex  flex-row w-80 mx-auto  md:w-full md:mb-16 relative md:static ">
                    <div className="w-full h-auto md:w-1/3 mx-auto ">
                        <img
                            ...
                            alt="Изображение"
                            className=" w-[176px] h-[176px] md:w-full md:h-auto rounded-lg transition-transform ease-in-out mt-[80%] md:-mt-20 -ml-4 md:-ml-0"
                        />
                    </div>
                    <div className="w-full h-auto md:w-1/3 absolute md:relative">
                        <img
                            ...
                            alt="Изображение"
                            className="w-[125.14px] h-[25.03] md:w-full md:h-[93px] ease-in-out mt-[60%]  ml-32 md:mt-[30%]  md:-ml-2 -rotate-45 md:rotate-[4deg]"
                        />
                    </div>
                    <div className="w-full h-auto  md:w-1/3 ">
                        <img
                            ...
                            alt="Изображение"
                            className="w-[184px] h-[184px] md:w-full md:h-auto rounded-lg transition-transform ease-in-out -mt-3 md:-mt-20  "
                        />
                    </div>
                </div>
                <img src="images/line.svg" alt="" className="w-full mx-auto pt-8 md:pt-16 md:px-5" />
                <div className="flex flex-col md:flex-row p-3 md:p-7 ">
                    <div className="w-full flex justify-between items-center gap-5 md:gap-6 overflow-x-auto no-scrollbar md:overflow-x-visible">
