...
const Footer = () => {
    const sections = [
        ...
        {
            title: "Services",
            items: ["Web Design & Development", "Branding", "Content Creation", "Technical", "Support"]
        },
    ...
    return (
        <div className=' bg-dark-1 w-full m-0 p-0'>
            <div className='bg-dark-1 h-1/2 w-full flex flex-col md:flex-row  md:justify-around items-center md:items-start p-10 md:p-20'>
